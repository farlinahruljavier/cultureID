...
<head>
	<title>Dashboard | CultureID</title>
	<meta charset="utf-8">
...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<!-- <div class="brand">
				<a href="index.php">CultureID | Admin</a>
			</div> -->
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="assets/img/user.png" class="img-circle" alt="Avatar"> <span>farlinahrul</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
							<ul class="dropdown-menu">
